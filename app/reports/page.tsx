      ...
      <div className="flex-1 lg:pl-64 flex flex-col min-w-0">
        ...
        <header className="sticky top-0 z-30 bg-white/90 backdrop-blur-md border-b border-slate-200/80 px-4 sm:px-8 py-4 flex items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl sm:text-2xl font-extrabold text-slate-900 tracking-tight leading-tight">Laporan & Analitik</h1>
              <p className="text-xs sm:text-sm text-slate-500 font-medium hidden sm:block">Pantau performa bisnis dan statistik pesanan jahitan.</p>
            </div>
          </div>
